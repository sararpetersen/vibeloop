...
function SheetContent({
  ...
  /** Set false when the caller renders its own dismiss control (e.g. PopupClose) instead of relying on this built-in one. */
  showClose?: boolean;
}) {
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "bottom" && "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom left-0 right-0 bottom-0 h-auto border-t",
          className,
        )}
        {...props}
      >
