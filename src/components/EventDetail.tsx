...
const eventAttendees = [
  { name: 'Tariq Al-Mansour', mood: 'Hopeful', color: '#FFD4A9', initial: 'TA' },
  { name: 'Elena Costa', mood: 'Excited', color: '#FFA9D4', initial: 'EC' },
  { name: 'Kenji Yamamoto', mood: 'Nervous', color: '#A9B8D9', initial: 'KY' },
  { name: 'Anika Singh', mood: 'Creative', color: '#D4A9FF', initial: 'AS' },
  { name: 'Marcus Brown', mood: 'Peaceful', color: '#B8E8E0', initial: 'MB' },
  { name: 'Isla Murphy', mood: 'Calm', color: '#A9C7FF', initial: 'IM' },
];
        ...
        >
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            <Card className="p-5 rounded-3xl border-2 border-[#E0E8F5] bg-white/80 backdrop-blur-sm space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {isFull && (
                    <div className="text-sm text-[#B8B8CC]">Gathering is full</div>
                  )}
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {eventAttendees.slice(0, event.attendees > 6 ? 6 : event.attendees).map((attendee, idx) => (
                  <motion.div
                    key={idx}
                  ...
                  >
                    <Card className="p-3 rounded-2xl border-2 border-[#E0E8F5] bg-white/80 backdrop-blur-sm flex items-center gap-3">
                      ...
                      {idx === 0 && (
                        <Badge className="px-2 py-0.5 text-xs rounded-full bg-[#A9C7FF]/20 text-[#6A6A88] border-0">
                          Host
                        </Badge>
                      )}
                    </Card>
          ...
          <div className="sticky bottom-0 bg-white/90 backdrop-blur-xl border-t-2 border-[#E0E8F5] px-6 py-4">
            <div className="flex gap-3">
              ...
              <Button
                onClick={() => !isFull && setIsAttending(!isAttending)}
                disabled={isFull}
