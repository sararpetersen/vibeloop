      ...
      >
        ...
        >
          <PopupHeader
            leading={
              <Badge
                className="px-3 py-1 rounded-full border-0 flex-shrink-0"
                style={{
                  backgroundColor: tint(eventColor, "medium"),
                  color: "#6A6A88",
                }}
              >
                {event.vibe}
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            <Card className="p-5 rounded-3xl border-2 border-[#E0E8F5] bg-white/80 backdrop-blur-sm space-y-4">
              <div className="flex items-start gap-3">
                <div
                  ...
                  style={{
                    backgroundColor: tint(eventColor, "subtle"),
                  }}
                >
                  <Calendar className="w-5 h-5" style={{ color: eventColor }} />
                </div>
                <div>
                  <div className="text-sm text-[#B8B8CC] mb-1">When</div>
                  ...
                  <div className="h-2 bg-[#F6F8FB] rounded-full overflow-hidden">
                    <motion.div
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 8px ${tint(eventColor, "border")}`,
                      }}
                      initial={{ width: 0 }}
            ...
            {/* What to Bring */}
            <div>
              <h3 className="text-[#4A4A6A] font-bold italic mb-1.5">What to bring</h3>
            ...
            <div>
              <div className="flex items-center justify-between">
                <h3 className="text-[#4A4A6A] font-bold italic mb-1.5">Who's coming</h3>
                  ...
                  eventAttendeesState.slice(0, event.attendees > 6 ? 6 : event.attendees).map((attendee, idx) => (
                    <motion.div key={idx} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: idx * 0.05 }}>
                      <Card className="p-3 rounded-2xl border-2 border-[#E0E8F5] bg-white/80 backdrop-blur-sm flex items-center gap-3">
                        <Avatar className="w-10 h-10 border-2" style={{ borderColor: tint(attendee.color, "borderStrong") }}>
                          <AvatarFallback
                            className="text-sm"
                            style={{
                              backgroundColor: tint(attendee.color, "medium"),
                              color: "#4A4A6A",
                            }}
                          >
                            {attendee.initial}
            ...
            {/* Additional Info */}
            <Card className="p-5 rounded-3xl border-2 bg-white/80 backdrop-blur-sm" style={{ borderColor: tint(eventColor, "subtle") }}>
          ...
          <div className="sticky bottom-0 bg-white/90 backdrop-blur-xl border-t-2 border-[#E0E8F5] px-6 py-4">
            <div className="flex gap-3">
              <Button
                ...
                style={{
                  background: `linear-gradient(135deg, ${tint(eventColor, "border")}, ${tint(eventColor, "subtle")})`,
                  color: "#6A6A88",
                  width: "56px",
                  padding: "0",
                }}
