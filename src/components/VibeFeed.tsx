...
export function VibeFeed({ selectedMood, setSelectedMood, userDreams = [] }: VibeFeedProps) {
  ...
  const allVibes = [...userDreams, ...vibesData];
  
  const filteredVibes = selectedMood === 'All' 
    ? allVibes 
    : allVibes.filter(v => v.mood === selectedMood);
              ...
              <div className="relative">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="flex-1 flex items-center gap-2">
                    ...
                    {vibe.isFollowing && (
                      <span className="text-xs px-2 py-0.5 rounded-full bg-[#A9C7FF]/20 text-[#6A6A88]">
                        following
                      </span>
                    )}
                  </div>
                  ...
                  >
                    ...
                    >
                      <motion.div
                        ...
                        animate={{
                          boxShadow: clickedOrbs.has(vibe.id) 
                            ? `0 0 30px ${vibe.moodColor}90` 
                            : `0 0 16px ${vibe.moodColor}60`,
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#B8B8CC] italic">
                        {clickedOrbs.has(vibe.id) ? 'Saved ✨' : 'Tap to collect'}
                      </p>
                    </div>
                  </motion.div>
                )}
