...
const chatMessageSets = {
  'The Creative Collective': [
    ...
    { author: 'Malik', text: "art doesn't have to make sense, it just has to feel right. what were you vibing with?", timestamp: '3h ago', color: '#C5A9FF' },
    { author: 'Yara', text: "been working on this poem for weeks and it's finally clicking. this space gives me so much energy", timestamp: '2h ago', color: '#A9C7FF' },
  ...
  'Late Night Walks': [
    ...
    { author: 'Viktor', text: "that's why i love these walks. everything feels big during the day, but at night... perspective shifts", timestamp: '1h ago', color: '#D4A9FF' },
  ...
  'Dream Journal Club': [
    { author: 'Hana', text: "had the weirdest dream last night... i was swimming through clouds?? like physically swimming", timestamp: '5h ago', color: '#C5A9FF' },
    { author: 'Liam', text: "duuude that sounds amazing. i had one where i was reading a book but the words kept changing", timestamp: '4h ago', color: '#A9C7FF' },
    { author: 'Safiya', text: "your subconscious is trying to tell you something Hana. swimming = moving through emotions maybe?", timestamp: '3h ago', color: '#D4A9FF' },
    { author: 'Anders', text: "i love how we can talk about this stuff here without people thinking we're weird lol", timestamp: '1h ago', color: '#FFD4A9' },
  ...
  'Book & Coffee Meetups': [
    ...
    { author: 'Amina', text: "been reading this book about slow living and it's hitting different. we need more spaces like this", timestamp: '2h ago', color: '#D4A9FF' },
    { author: 'Felix', text: "Amina what's it called? always looking for book recs", timestamp: '1h ago', color: '#A9C7FF' },
    { author: 'Suki', text: "silent reading session next week is gonna be cozy. bringing my favorite herbal tea", timestamp: '45m ago', color: '#FFD4A9' },
  ],
  'Astronomy Club': [
    { author: 'Tariq', text: "watched a documentary about black holes last night and now i can't stop thinking about infinity", timestamp: '4h ago', color: '#C5A9FF' },
    { author: 'Mira', text: "infinity freaks me out in the best way. like we're made of stardust and we'll return to it", timestamp: '3h ago', color: '#A9C7FF' },
    { author: 'Oskar', text: "philosophy talk got deep last time. existentialism but make it chill", timestamp: '2h ago', color: '#D4A9FF' },
    { author: 'Nia', text: "that's what i love about this group. we can talk about the cosmos without being pretentious", timestamp: '1h ago', color: '#E0C9D9' },
    { author: 'Kenji', text: "next astronomy night is friday! bringing my telescope if anyone wants to look at saturn", timestamp: '30m ago', color: '#FFD4A9' },
  ],
  'The Support Circle': [
    ...
    { author: 'Luna', text: "gentle reminder that healing isn't linear. some days are just hard and that's okay", timestamp: '1h ago', color: '#D4A9FF' },
    ...
    { author: 'Zainab', text: "anyone coming to art therapy tomorrow? been working through some stuff and creating helps", timestamp: '25m ago', color: '#FFD4A9' },
  ],
  'Quiet Tea Night': [
    { author: 'Rowan', text: "first time coming tonight! what should i expect?", timestamp: '2h ago', color: '#A9C7FF' },
    { author: 'Davi', text: "it's super chill Rowan! literally just vibing in silence. bring something warm to sit on", timestamp: '1h ago', color: '#C5A9FF' },
  ...
  'Art & Coffee Session': [
    ...
    { author: 'Kaia', text: "last session was so fun. painted the worst sunset ever but felt amazing doing it lol", timestamp: '1h ago', color: '#FFD4A9' },
  ...
  'Midnight Walk': [
    ...
    { author: 'Javier', text: "planning a route through the quiet neighborhoods. maybe stop at that 24h cafe?", timestamp: '3h ago', color: '#A9C7FF' },
    { author: 'Mei', text: "bring your dream journals! last time we had such good convos under the streetlights", timestamp: '2h ago', color: '#D4A9FF' },
    { author: 'Finn', text: "this is my favorite event. something about walking at night makes everything feel magical", timestamp: '1h ago', color: '#E0C9D9' },
  ],
  'Sunrise Movement': [
    { author: 'Zara', text: "who else is crazy enough to be up at 6am on a saturday? 🌅", timestamp: '3h ago', color: '#FFD4A9' },
    { author: 'Akira', text: "me!! sunrise movement sessions are worth it every time. the energy is unmatched", timestamp: '2h ago', color: '#D4A9FF' },
  ...
  'Journaling Session': [
    { author: 'Yasmin', text: "excited for tomorrow's session. been journaling all week and have so much to process", timestamp: '4h ago', color: '#E0C9D9' },
    { author: 'Luca', text: "remember there's no pressure to share! just write what feels right", timestamp: '3h ago', color: '#C5A9FF' },
    { author: 'Priya', text: "these circles have helped me understand myself better. writing is underrated therapy", timestamp: '2h ago', color: '#D4A9FF' },
...
const generateMockMessages = (loopName: string, type: 'community' | 'event'): Message[] => {
  ...
  const fallbackMessages = type === 'event' ? [
    ...
    <Sheet open={isOpen} onOpenChange={onClose}>
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <SheetDescription className="text-sm text-[#8A8AA8] mt-0.5">
                {type === 'community' ? 'Community chat' : 'Event chat'}
              </SheetDescription>
            </div>
          </div>
        </SheetHeader>
            ...
            {messages.map((message, index) => (
              ...
              >
                <div className={`max-w-[80%] ${message.isOwn ? 'items-end' : 'items-start'} flex flex-col gap-1`}>
                  {!message.isOwn && (
                    <span className="text-xs text-[#B8B8CC] px-3">{message.author}</span>
                  )}
                  <div
                    ...
                    style={{
                      ...
                      border: message.isOwn 
                        ? `1px solid ${loopColor}40`
                        : '1px solid #E0E8F5',
                      boxShadow: message.isOwn 
                        ? `0 4px 16px ${loopColor}20`
        ...
        >
          ...
          {/* Gentle reminder */}
          <p className="text-xs text-[#B8B8CC] mt-3 text-center italic">
            This is a safe space. Be gentle with yourself and others.
          </p>
        </div>
      </SheetContent>
    </Sheet>
