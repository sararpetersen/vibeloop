...
const recentMembers = [
  { name: 'Nisha Kapoor', mood: 'Calm', color: '#A9C7FF', initial: 'NK' },
  { name: 'Omar Hassan', mood: 'Dreamy', color: '#C5A9FF', initial: 'OH' },
  { name: 'Mia Santos', mood: 'Creative', color: '#D4A9FF', initial: 'MS' },
  { name: 'Liam O\'Connor', mood: 'Reflective', color: '#E0C9D9', initial: 'LO' },
  { name: 'Aaliyah Johnson', mood: 'Peaceful', color: '#A9C7FF', initial: 'AJ' },
];

const upcomingEvents = [
  { name: 'Weekly Art Share', date: 'Tomorrow, 7:00 PM', attendees: 12 },
  { name: 'Quiet Coffee Morning', date: 'Friday, 10:00 AM', attendees: 8 },
  { name: 'Dream Circle', date: 'Saturday, 8:00 PM', attendees: 15 },
];
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Badge className="px-3 py-1 rounded-full bg-white/80 text-[#8A8AA8] border-2 border-[#E0E8F5]">
                  {loop.founded}
                </Badge>
              </div>
            </div>
              ...
              <Button
                ...
                style={{
                  background: hasJoined
                    ...
                    : `linear-gradient(135deg, ${loop.color}EE, ${loop.color}AA)`,
